...
class NewReplyReport extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {   
        ...
        return (new MailMessage)
                    ...
                    ->markdown('mail.replies.new', ['user' => $notifiable, 'report' => $this->report, 'comment' => $this->comment]);
    }
