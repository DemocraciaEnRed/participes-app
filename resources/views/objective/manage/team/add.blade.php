...
<section>
  ...
  <hr>
  <objective-search-user-add-team fetch-url="{{ route('apiService.users') }}" form-url="{{ route('objective.manage.team.add.form', ['objectiveId' => $objective->id]) }}" crsf-token="{{ csrf_token() }}"/>
