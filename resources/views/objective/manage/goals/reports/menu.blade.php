...
<div class="menu-link">
<a href="{{ route('objectives.manage.goals.reports.edit', ['objectiveId' => $objective->id, 'goalId' => $goal->id, 'reportId' => $report->id]) }}" class="item-link {{ $currentRoute == 'objective.manage.edit'  ? 'is-active' : null }}">Editar reporte</a>
<a href="{{ route('objectives.manage.goals.reports.configuration', ['objectiveId' => $objective->id, 'goalId' => $goal->id, 'reportId' => $report->id]) }}" class="item-link {{ $currentRoute == 'objective.manage.goals.reports.configuration'  ? 'is-active' : null }}">Configuración</a>
