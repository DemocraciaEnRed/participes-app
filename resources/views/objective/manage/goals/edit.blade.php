...
<section>
  ...
  <form method="POST" action="{{ route('objectives.manage.goals.edit.form',['objectiveId' => $objective->id, 'goalId' => $goal->id]) }}">
    ...
    <div class="form-row">
      <div class="col">
        <div class="form-group">
          <label class="is-700">Valor de meta (100%) del indicador</label>
      ...
      <div class="col">
        <div class="form-group">
          <label class="is-700">Valor inicial del indicador <small class="text-info">Opcional</small></label>
    ...
    <div class="form-row">
      <div class="col">
        <div class="form-group">
          <label class="is-700">Unidad del indicador</label>
      ...
      <div class="col">
        <div class="form-group">
          <label class="is-700">Frecuencia de monitoreo <small class="text-info">Opcional</small></label>
    ...
    <div class="form-group">
      <label class="is-700">Estado inicial de la meta</label>
    ...
    <div class="form-group">
      <label class="is-700">Fuente de los datos <small class="text-info">Opcional</small></label>
