...
<section>
  ...
  <form method="POST" action="{{ route('objectives.manage.edit.form',['objectiveId' => $objective->id]) }}">
    ...
    <div class="border border-light rounded p-3">
      ...
      @endif
      <small class="form-text text-muted">Se le enviará una notificación por email (si lo tienen habilitado) y por sistema, de que el objetivo ha sido editado, invitandolos a verla.</small>
    </div>
    <br>
